...
import com.springheroes.wellco.repositories.CommentEventRepository;
import com.springheroes.wellco.repositories.EventRepository;
import com.springheroes.wellco.repositories.FavouriteRepo;
import com.springheroes.wellco.repositories.LikeEventRepo;
import com.springheroes.wellco.repositories.NoteERepository;
...
public class EventServiceImp implements IEventService {
	...
	/* ADD EVENT */
	@Override
	public Event addEvent(Event e, EventType eventType, Integer idOffice) {
	...
	public void commentEvent(Integer idEvent, Long idUser, String comment) {
		...
		if(u.getBadWords()<=3) {
			...
			co.setEvent(e);
			co.setUser(u);
			co.setAuthor(u.getFirstName() + " " + u.getLastName());
			co.setContent(com);
